...
const Design1 = () => {
  ...
  return (
    <div>
        ...
        <div className="py-10 gap-2 bg-blue-100 h-screen flex flex-col items-center">
          {userData ? (
            <>
              ...
              <section>
                {userData.location ? (
                  <span className="border border-black rounded-xl px-3 py-1">
                    {userData.location}
                  </span>
                ) : (
                  ""
      ...
      {/* <div className="absolute right-1 w-10 h-10 border rounded-full flex items-center justify-center border-black">
        <Forward />
      </div> */}
    </div>
  );
